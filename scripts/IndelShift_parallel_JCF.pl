...
# JCF edit May2024- orginally written to grab all files in directory- slow! edited to take just one file so can be run in parallell
...
###############################################################
# JCF edit- don't get all files from dir, take from command line
#open directory
